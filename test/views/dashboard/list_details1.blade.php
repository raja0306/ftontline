      ...
      <div class="row">
        <div class="col-xl-4">
          <div class="text-center" dir="ltr">
              ...
              <input class="knob dial_{{$lids->list_id}}" data-width="80" data-min="0" data-displayprevious="true" data-max="1000" data-step="1" value="200" data-fgcolor="#2a3142" id="total{{$lids->list_id}}" readonly="">
          </div>
        </div>
        ...
        <div class="col-xl-4">
          <div class="text-center" dir="ltr">
              ...
              <input class="knob dial_{{$lids->list_id}}" data-width="80" data-min="0" data-displayprevious="true" data-max="1000" data-step="1" value="200" data-fgcolor="#50a5f1" id="dialnew{{$lids->list_id}}" readonly="">
          </div>
        </div>
        ...
        <div class="col-xl-4">
          <div class="text-center" dir="ltr">
              ...
              <input class="knob dial_{{$lids->list_id}}" data-width="80" data-min="0" data-displayprevious="true" data-max="1000" data-step="1" value="200" data-fgcolor="#34c38f" id="answer{{$lids->list_id}}" readonly="">
          </div>
        </div>
        ...
        <div class="col-xl-4">
          <div class="text-center" dir="ltr">
              ...
              <input class="knob dial_{{$lids->list_id}}" data-width="80" data-min="0" data-displayprevious="true" data-max="1000" data-step="1" value="200" data-fgcolor="#f1b44c" id="noanswer{{$lids->list_id}}" readonly="">
          </div>
        </div>
        ...
        <div class="col-xl-4">
          <div class="text-center" dir="ltr">
              ...
              <input class="knob dial_{{$lids->list_id}}" data-width="80" data-min="0" data-displayprevious="true" data-max="1000" data-step="1" value="200" data-fgcolor="#6f42c1" id="busy{{$lids->list_id}}" readonly="">
          </div>
        </div>
        ...
        <div class="col-xl-4">
          <div class="text-center" dir="ltr">
              ...
              <input class="knob dial_{{$lids->list_id}}" data-width="80" data-min="0" data-displayprevious="true" data-max="1000" data-step="1" value="200" data-fgcolor="#f46a6a" id="drop{{$lids->list_id}}" readonly="">
          </div>
        </div>
      </div>
    </div>
...
$listnames = App\VicidialLists::select('list_name')->where('list_id',$lids->list_id)->first();
    ...
    if($lids->list_id=='999'){
      ...
      $dial_lists_b = App\VicidialCloserLog::whereBetween('call_date',[$fromdate, $todate1])->where('list_id',$lids->list_id)->where('status','B')->count();
      ...
      $dial_lists_b = App\VicidialLog::whereBetween('call_date',[$fromdate, $todate1])->where('list_id',$lids->list_id)->where('status','B')->count();
