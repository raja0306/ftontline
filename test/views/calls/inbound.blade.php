            ...
            <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($log->status=='DROP'||$log->status=='NANQUE'||$log->status=='B'||$log->status=='NA')
                            Missed  
                            @if($status=='missed') 
...
$('#submitbtn').click(function() {
    ...
    var submiturl = "{{url('/calls/inbound')}}?status="+status+"&fromdate="+fdate+"&todate="+todate+"&phone="+phone+"&campaign="+campaign;
