        ...
        <div class="card-body">
            <table id="datatable-buttons" class="table table-bordered w-100">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{$x++}}</td>
                        <td>Shipment Upload</td>
                        <td><a href="{{asset('/assets')}}/upload/shipments-upload-new.csv" class="mb-2 btn btn-outline-secondary waves-effect waves-light btn-sm font-size-18 editbtn"><i class="mdi mdi-download"></i></a></td>
                    </tr>
                    <!-- <tr>
                        <td>{{$x++}}</td>
