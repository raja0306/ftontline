...
<div class="col-12">
    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
        <h4 class="mb-sm-0 font-size-18">Print Uploaded Shipments</h4>
    ...
    <div class="card-body pt-0">
        <div class="row">
            <div class="col-sm-12 pt-3">
                <form  action="{{url('/upload/shipment/print')}}" method="post">
                    {{csrf_field()}} 
                <div class="row">
                    <div class="col-lg-3">
                        <div>
...
<form method="post" action="{{url('upload/shipment/printlist')}}" id="labelgenerate">
    @csrf
