...
<div class="row mt-4">
    ...
    <div class="col-md-12">
        ...
        <li class="nav-item waves-effect waves-light">
            <a class="nav-link addrType jj-1" data-id="1" data-bs-toggle="tab" href="#new_address" role="tab">
    ...
    <div class="col-md-12 border shadow-none tab-content mt-2 py-3">
            ...
            <div class="col-md-3">
                ...
                <div class="form-check mb-3">
                    <input class="form-check-input" type="radio" name="preference"
                        id="preference-ladies" value="Ladies" @if($appoint->preference=='Ladies')checked @endif>
                ...
                <div class="form-check mb-3">
                    <input class="form-check-input" type="radio" name="preference"
                        id="preference-men" value="Men" @if($appoint->preference=='Men')checked @endif>
            ...
            <div class="col-md-3">
                ...
                <div class="form-check mb-3">
                    <input class="form-check-input" type="radio" name="reqfrom"
                        id="reqfrom-ladies" value="Client" @if($appoint->req_from=='Client')checked @endif>
                ...
                <div class="form-check mb-3">
                    <input class="form-check-input" type="radio" name="reqfrom"
                        id="reqfrom-men" value="Branch" @if($appoint->req_from=='Branch')checked @endif>
        ...
        <div class="branch_id tab-pane addrType-3 @if($appoint->address_type==1||$appoint->address_type==3) active @endif" id="address_list" role="tabpanel">
            <div>
                ...
                @if($customer)
                <div class="form-check mb-3">
                    <input class="form-check-input useraddress_id" type="radio" name="useraddress_id" data-id="{{$addr->area_id}}" id="addrslot_id-{{$addr->id}}" value="{{$addr->id}}" @if($appoint->useraddress_id==$addr->id)checked required @endif >
                    <label class="form-check-label" for="addrslot_id-{{$addr->id}}">
                        ...
                        <span role="button" class="btn btn-sm btn-dark ms-3 edit_addr" data-area_id="{{$addr->area_id}}" data-block="{{$addr->block}}" data-street="{{$addr->street}}" data-avenue="{{$addr->avenue}}" data-house_no="{{$addr->house_no}}" data-floor_no="{{$addr->floor_no}}" data-pacii_no="{{$addr->pacii_no}}" data-landmark="{{$addr->landmark}}" data-flat_no="{{$addr->flat_no}}" data-lat="{{$addr->lat}}" data-longi="{{$addr->longi}}" data-flat_no="{{$addr->flat_no}}">Edit</span>
                    </label>
                </div>
                @endif
                @endforeach
