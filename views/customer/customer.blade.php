  ...
  <div id="layout-wrapper">
    <header id="page-topbar">
      <div class="navbar-header">
        ...
        <div class="mt-3">
            <a href="{{'/frontline/index.php/book/customer'}}/{{$mobile}}/{{$user}}/{{$listid}}/{{$campaignid}}/{{$ingroup}}/{{$leadid}}">@if($listid==999)<span class="badge rounded-pill bg-info mx-2 font-size-16 p-2 float-end">Incoming - {{$listname}}</span>@else<span class="badge rounded-pill bg-success mx-2 font-size-16 p-2 float-end">Outgoing - {{$listname}}</span>@endif</a>
        </div>
    </div>
<div class="d-flex">
