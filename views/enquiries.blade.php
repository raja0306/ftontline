            ...
            <div class="col-sm-12 pt-3">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 mt-4">
                        ...
                        <a href="#" class="btn btn-outline-danger waves-effect waves-light d-none StatusDiv" onclick="$('#labelgenerate').submit();">Export Label</a>
                    </div>
                </form>
                </div>
            </div>
            ...
            <table id="datatable-buttons" class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>@if($appointment->address_type==1) Customer @else Branch @endif</td>
                        ...
                        <td>{{ date('d M, Y H:i A',strtotime($appointment->updated_at)) }}</td>
                        <td>{{ $appointment->createduser->name ?? '-' }}</td>
                        <td>{{ $appointment->updateduser->name ?? '-' }}</td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
