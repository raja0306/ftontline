...
/*            border: 0.1mm solid #ddd;*/
        ...
        /* Row 5 */
        .label:nth-child(11) { top: 291mm; left: 0mm; }
        .label:nth-child(12) { top: 291mm; left: 105mm; }
        /* Row 5 */
        .label:nth-child(13) { top: 348mm; left: 0mm; }
        .label:nth-child(14) { top: 348mm; left: 105mm; }
        /* Row 5 */
        .label:nth-child(15) { top: 405mm; left: 0mm; }
        .label:nth-child(16) { top: 405mm; left: 105mm; }

        .label:nth-child(17) { top: 462mm; left: 0mm; }
        .label:nth-child(18) { top: 462mm; left: 105mm; }
        
        .label:nth-child(19) { top: 519mm; left: 0mm; }
        .label:nth-child(20) { top: 519mm; left: 105mm; }
        
        /*.label:nth-child(21) { top: 576mm; left: 0mm; }
        .label:nth-child(22) { top: 576mm; left: 105mm; }*/
